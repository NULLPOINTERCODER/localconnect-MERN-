  ...
  with (locals || {}) {
    ...
    ; __line = 448
    ; __append(escapeFn( order.created_at.timestamp() ))
    ; __append("\">")
    ...
    ; __append("\"></i>\r\n                            ")
    ; __line = 466
    ; __append(escapeFn( order.delivery_type|title ))
    ...
    ; __append("\r\n                        </button>\r\n                        ")
    ; __line = 496
    ;  } else if (order.status == 'ready' && order.delivery_type == 'takeaway') { 
    ; __append("\r\n                        <button class=\"btn-action accept\" onclick=\"updateOrderStatus(")
    ; __line = 497
    ; __append(escapeFn( order.id ))
    ; __append(", 'Completed')\">\r\n                            Order Delivered\r\n                        </button>\r\n                        ")
